# -*- coding: utf-8 -*-
"""b476_regspec.py -- THE REGISTRATION'S SATISFIABILITY SPEC. ### **COMPUTED, NOT TYPED.**
...
REG = os.path.join(ROOT, 'data', 'b476_registration_2026-09-22.txt')
SPEC = os.path.join(ROOT, 'data', 'b476_satisfiable.json')
...
CLAUSES = [
    ...
    ('chains run, or channel values computed', 36, 36, 'runs', '### (R70): ONE diagonal rehearsal at a=1.5, and 35 transform evaluations pricing the resolving size. ### NO GRAM ENTRY.'),
    ...
    ('addendum slots declared in the write list', 1, 1, 'slots', '### (W) and (R50): data/b476_addendum.txt.'),
...
def main(argv):
    print('=' * 100)
    print('b476_regspec.py -- THE SATISFIABILITY SPEC. ### THE COUNTER IS IMPORTED, NOT COPIED.')
    print('=' * 100)
    ...
    spec = {"registration": ("data/b476_registration_2026-09-22.txt -- b458, "
