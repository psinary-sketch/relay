# -*- coding: utf-8 -*-
"""b524_reg_gate.py -- THE REGISTRATION GATE, RUN BEFORE THE LOCK. ### ALL THREE ARMS.
...
REG = os.path.join(D, 'b524_registration_2026-09-25.txt')
OUT = os.path.join(D, 'b524_reg_gate.txt')
...
def main():
    rec('=' * 100)
    rec('b524 -- THE REGISTRATION GATE, RUN BEFORE THE LOCK.')
    rec('=' * 100)
