# -*- coding: utf-8 -*-
"""b466_regspec.py -- THE REGISTRATION'S SATISFIABILITY SPEC. ### **COMPUTED, NOT TYPED.**
...
REG = os.path.join(ROOT, 'data', 'b466_registration_2026-09-21.txt')
SPEC = os.path.join(ROOT, 'data', 'b466_satisfiable.json')
...
CLAUSES = [
    ...
    ('addendum slots declared in the write list', 1, 1, 'slots', '### (W) and (R50): data/b466_addendum.txt.'),
...
def main(argv):
    print('=' * 100)
    print('b466_regspec.py -- THE SATISFIABILITY SPEC. ### THE COUNTER IS IMPORTED, NOT COPIED.')
    print('=' * 100)
    ...
    spec = {"registration": ("data/b466_registration_2026-09-21.txt -- b458, "
