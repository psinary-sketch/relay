# -*- coding: utf-8 -*-
"""b342_regspec.py -- THE REGISTRATION'S SATISFIABILITY SPEC, ### **COMPUTED, NOT TYPED.**
...
REG = os.path.join(ROOT, 'data', 'b342_registration_2026-09-06.txt')
SPEC = os.path.join(ROOT, 'data', 'b342_satisfiable.json')

if hasattr(sys.stdout, 'reconfigure'):
    sys.stdout.reconfigure(encoding='utf-8', errors='replace')

CLAUSES = [
    ("TECHNE files written", 3, 3, "files", "### section (G): two modules and the index, by an appended block."),
    ("TECHNE files edited", 0, 0, "files", "### section (C): the untouched check."),
    ("TECHNE pushes", 0, 0, "pushes", "### section (A): PRIVATE; the remote read before and after."),
    ("PLACE-papers files written", 1, 1, "files", "### section (D): FINDINGS.md, one appended block."),
    ("findings lines edited", 0, 0, "lines", "### section (D): a true prefix of its blob."),
    ("faces ledger rows or blocks written", 0, 0, "blocks", "none."),
...
def main(argv):
    print('=' * 100)
    print('b342_regspec.py -- THE SATISFIABILITY SPEC. ### THE COUNTER IS IMPORTED, NOT COPIED.')
    print('=' * 100)
    ...
    spec = {"registration": "data/b342_registration_2026-09-06.txt -- b342, THE TWO RULES AS MODULES", "clauses": clauses}
