# -*- coding: utf-8 -*-
"""b452_regspec.py -- THE REGISTRATION'S SATISFIABILITY SPEC. ### **COMPUTED, NOT TYPED.**
...
REG = os.path.join(ROOT, 'data', 'b452_registration_2026-09-14.txt')
SPEC = os.path.join(ROOT, 'data', 'b452_satisfiable.json')
...
CLAUSES = [
    ...
    ('mirror zips written outside a repository', 1, 1, 'zips', '### section (W): mirror-refresh-2026-09-14-b452.zip.'),
    ...
    ('addendum slots declared in the write list', 1, 1, 'slots', '### (W) and (R50): data/b452_addendum.txt.'),
    ...
    ('re-expressions performed', 0, 0, 're-expressions', '### (K) BAR 4.'),
    ('sites proposed', 0, 0, 'sites', '### (K) BAR 4.'),
    ('candidates re-attempted', 0, 0, 'candidates', '### section (Z).'),
...
def main(argv):
    print('=' * 100)
    print('b452_regspec.py -- THE SATISFIABILITY SPEC. ### THE COUNTER IS IMPORTED, NOT COPIED.')
    print('=' * 100)
    ...
    spec = {"registration": ("data/b452_registration_2026-09-14.txt -- b452, "
                             "THE CLASS BOUNDARY READ BY ITS SIDE, AND THE SIX SITES READ BY THEIR GENERATOR"),
            "clauses": clauses}
