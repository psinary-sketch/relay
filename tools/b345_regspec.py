# -*- coding: utf-8 -*-
"""b345_regspec.py -- THE REGISTRATION'S SATISFIABILITY SPEC, ### **COMPUTED, NOT TYPED.**
...
REG = os.path.join(ROOT, 'data', 'b345_registration_2026-09-06.txt')
SPEC = os.path.join(ROOT, 'data', 'b345_satisfiable.json')

if hasattr(sys.stdout, 'reconfigure'):
    sys.stdout.reconfigure(encoding='utf-8', errors='replace')

CLAUSES = [
    ("PLACE-papers files written", 2, 2, "files", "### section (H): FACES_LEDGER.md one block; OPEN_TRAILS.md one block."),
    ...
    ("bars moved", 0, 0, "bars", "### section (D): b340's stays unmet; this act's is its own."),
    ("acts re-verdicted", 0, 0, "acts", "section (A)."),
    ("axes moved", 0, 0, "axes", "### section (E): the work-order names them and prices nothing."),
    ...
    ("zero-side or finite-side evaluations", 0, 0, "evaluations", "### section (A): the archimedean constituent only."),
    ("indices added or removed after a value", 0, 0, "indices", "### section (D): the keystone's rows."),
    ("`.lean` files edited", 0, 0, "files", "none."),
    ("TECHNE files written", 0, 0, "files", "none."),
    ("deposited texts touched", 0, 0, "files", "none."),
    ("owner instrument files edited", 0, 0, "files", "### imported, never edited."),
...
def main(argv):
    print('=' * 100)
    print('b345_regspec.py -- THE SATISFIABILITY SPEC. ### THE COUNTER IS IMPORTED, NOT COPIED.')
    print('=' * 100)
    ...
    spec = {"registration": "data/b345_registration_2026-09-06.txt -- b345, THE LI CONTROL, RE-RUN", "clauses": clauses}
