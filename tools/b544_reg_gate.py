# -*- coding: utf-8 -*-
"""b544_reg_gate.py -- THE REGISTRATION GATE, RUN BEFORE THE LOCK. ### ALL THREE ARMS.
...
REG = os.path.join(D, 'b544_registration_2026-09-26.txt')
OUT = os.path.join(D, 'b544_reg_gate.txt')
...
def main():
    rec('=' * 100)
    rec('b544 -- THE REGISTRATION GATE, RUN BEFORE THE LOCK.')
    rec('=' * 100)
