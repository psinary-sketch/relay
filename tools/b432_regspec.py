# -*- coding: utf-8 -*-
"""b432_regspec.py -- THE REGISTRATION'S SATISFIABILITY SPEC. ### **COMPUTED, NOT TYPED.**
...
REG = os.path.join(ROOT, 'data', 'b432_registration_2026-09-12.txt')
SPEC = os.path.join(ROOT, 'data', 'b432_satisfiable.json')
...
CLAUSES = [
    ...
    ('lanes opened', 0, 0, 'lanes', '### (K) BAR 1.'),
    ('addresses resolved or documents fetched', 0, 0, 'reads', '### section (Z): nothing is fetched by this act.'),
    ('candidate zeros, seeds or arrangements constructed', 0, 0, 'candidates', '### (K) BAR 1.'),
    ('corpus .lean files edited', 0, 0, 'files', '### section (Z).'),
    ...
    ('keystones edited or annotated', 0, 0, 'keystones', '### (K) BAR 8 and section (Z).'),
...
def main(argv):
    print('=' * 100)
    print('b432_regspec.py -- THE SATISFIABILITY SPEC. ### THE COUNTER IS IMPORTED, NOT COPIED.')
    print('=' * 100)
    ...
    spec = {"registration": ("data/b432_registration_2026-09-12.txt -- b432, THE EXTERNAL GRADING READ"),
            "clauses": clauses}
