...
KEYS = {
    ...
    'the-fixed-point-named-the-break-attributed-and-two-facts-built': ['what is u0 and is it 2 pi', 'is the archimedean kernel a zero counting density', 'can the weight table be stated axiom free', 'what does cosh v over 2 weight', 'why is the seed profile not scale invariant'],
    'the-fixed-profile-the-fixed-point-and-one-arithmetic-claim': ['is the seed autocorrelation a fixed profile', 'whose was the shell boundary spread', 'which prime power has the largest weight', 'why does the two term dominate', 'what is u0 and has any act named it'],
    'what-alternates-the-sign-and-where-the-room-closes': ['what alternates the prime sum sign', 'do entering prime powers flip the sum', 'where does the archimedean channel close', 'is the archimedean zero a property of h plus or of the family', 'what is the shell boundary in v over log a'],
    'the-window-opened-by-rungs': ['the window opened by rungs', 'does the prime constituent overtake the archimedean one', 'what happens past a = 3 on the window ladder', 'why does the ratio cross one at a = 5.385', 'was the noise floor ever priced past 1.41'],
    'the-witness-arc-at-site-iv-the-window': ['the witness arc at site (iv)', 'the window, and what would bound its prime sum', 'does the prime constituent overtake the archimedean quantity', 'is the navigator`s Chebyshev bound a witness', 'were the two sides ever normalized against each other'],
    'the-cure-shared-and-the-skips-that-print-like-passes': ['a cure that lives in one tool is not a guard', 'where did b314`s read-only handler go', 'which rmtree call sites were repointed', 'the skip that prints like a pass', 'how many single-tool cures does the corpus carry'],
    'the-external-grading-arc-folded': ['the external-grading arc', 'the fold b423 to b432', 'a tool asked not to complain', 'which incidents carry a guard', 'why did b433 reinvent b314`s handler'],
    'the-five-rulings-executed': ['the five rulings executed', 'the fourth grade defined', 'crt exhaustiveness annotated', 'the finite side prose narrowed', 'where is NOT THE CLAIM defined'],
    'the-disproof-lane-restated': ['the disproof lane', 'what a disproof would have to state', 'which form the negative control is for', 'the two shapes of a disproof', 'is there an instrument for the universal negative'],
    ...
    'the-substrate-at-grade': ['is the substrate non-extension compiled', 'which formation tuple components are derived', 'are the sibling programme ratios forced or permitted', 'how many sibling programmes are on this drive', 'what would it cost to run the S D split experiment', 'does the corpus carry a named finite set of primes'],
    'the-predicate-named': ['what condition does the compact smear identity need', 'is the finite side seal general in p', 'does Core carry a primality notion', 'how does the kernel record a statement it has not proved', 'how far can decide reach on the finite side grid', 'what did the seal header get wrong about primality'],
...
INDEX = [
    ...
    ('site-vi-and-the-arcs-product-named', "b443 (site (vi), and the arc's product named)",
     ...
     '### NO GRADE MOVED. ### NO CELL WRITTEN. ### NO CLAIM ABOUT RH, h2 OR ANY PRIME PROBLEM',
     'data/b443r_the_arc_product.txt; data/b443r_components.txt; data/b443r_site_vi.json; data/b443r_u1_draft.md; data/b443r_registration_2026-09-12.txt (LOCKED, 8 gates read, 4 by digest); FACES_LEDGER.md; OPEN_TRAILS.md; CORRESPONDENCE.md row 292'),
    # ### THE MINIMUM NAMED, AND SITE (v) (b442).
    ('the-minimum-named-and-site-v', 'b442 (the minimum named, and site (v))',
     "b442 NAMED u0 AND RAN SITE (v). u0 IS THE MINIMUM OF THE RIEMANN-SIEGEL theta ON 0 <= t <= 50: the argmin found from theta's values alone agrees with b440's u0 to 1.6e-20, theta at u0 is -3.5309728290166074377 by TWO ROUTES SHARING NO CODE, THETA IS ODD so there is no minimum on the whole line, and h+ changes sign once on (0, 50]. FILED DERIVES-ON-IMPORTS on K5. The record holds DEFINING EQUATION, CLASSICAL ASYMPTOTE AND NAME; CLOSED FORM NOT HELD; THE CLASSICAL VALUE NOT SOURCED. THE MECHANISM STAYS A HEURISTIC. SITE (v) EXHAUSTED: 10 candidates, 0 held, CLASS BOUNDARY 7; COORDINATE BOUNDARY 1; BOUNDED BY A MEASUREMENT 1; REFUTED 1; THE OBSTRUCTION IS MEMBERSHIP, NOT UNIFORMITY, over the corpus's two objects; NO NEW KIND AT FIVE SITES; THE ARC CHECKPOINTED AFTER (v). ROW U1'S TRANSCRIPTION OF THEOREM 6.1 NOTED, NOT REPAIRED. b440'S TWO CORRECTIONS ENTERED AS b440'S BESIDE ROW 289, IN b441'S WORDS, AND THE WRONG REPAIR RULE origin/main == HEAD NAMED. 0 INSTRUMENTS, 0 LANES, 0 CELLS, 0 CONTENT LOST",
     '### NO GRADE MOVED, CONFERRED OR MINTED. ### THE NAME IS DERIVES-ON-IMPORTS ON K5. ### NO CELL WRITTEN. ### NO CLAIM ABOUT RH, h2 OR ANY ZERO',
     'data/b442_the_minimum.txt; data/b442_components.txt; data/b442_theta.json; data/b442_site_v.json; data/b442_registration_2026-09-12.txt (LOCKED, 8 gates read, 4 by digest); FACES_LEDGER.md (two b442 blocks); OPEN_TRAILS.md; CORRESPONDENCE.md row 291'),
    # ### THE IDENTIFICATION FILED, THE OVERSTATEMENT CORRECTED, AND TWO FILINGS (b441).
    ('the-identification-filed-the-overstatement-corrected-and-two-filings', 'b441 (the identification filed, the overstatement corrected, and two filings)',
     "b441 RESTATED THE LINE b440 CALLED A DENIAL, FILED THE IDENTIFICATION IN TWO HALVES, PRICED WHAT IT BUYS, MEASURED THE PUSH-SIDE DEFECT'S REACH, AND MINTED ONE LORE. SPIRAL_MAP.md:114 DENIES A DIFFERENT RELATION: that SIDE-window's prime-power counting function is related to W_2/W_inf, a true disclaimer about a name collision saying nothing about zero-ordinates; IT STAYS UNEDITED, and THE WORD DENIAL WAS THIS SEAT'S, in b440's components and closing, repeated by the navigator's premise. THE KERNEL HALF WAS ALREADY CARRIED: CC (153)-(154) says h+ IS THE DERIVATIVE OF 2 theta, the Riemann-Siegel angular function; b333 quoted it and K5 sits on it, so b440's not-carried HELD ONLY OVER PLACE-papers PROSE. THE COUNTING HALF IS NEW AND MEASURED: THE MAIN TERM MINUS theta(T)/pi IS 1 - 1/(48 pi T) + O(T^-3), THE 1 BEING THE POLE, by TWO ROUTES SHARING NO CODE (quad over digamma; loggamma with no quadrature) agreeing to 9.4e-38 against 1e-12 stated first; filed MEASURED, NOT A THEOREM, through the writer's append_block under S1/K5. PRICED, NOTHING IMPORTED: of five verified-source statements, EXACT AT EVERY HEIGHT ['c1'], UNIFORM ONLY IN THE O-SENSE ['c2', 'c4', 'c5'], DOMAIN NOT STATED ['c3']; SITE (ii)'S B3 AND B5 BOTH STAND, because the channel contains no real part and A COUNT UNIFORM IN THE HEIGHT PLACES NO ZERO. THE POLE'S DOUBLE ROLE IS FILED AS A JUXTAPOSITION, NO MECHANISM. THE PUSH-SIDE REACH, READ FROM GIT HISTORY: THE BROKEN PREDICATE WAS FIRST COMMITTED IN ['b440'] ALONE, ['b430'] HAD NONE, EVERY PRE-PUSH FILE WAS COMMITTED ONCE, AND 0 OF 11 BANKS SHOW ONE READING, so b440's 'STILL LIVE IN EVERY ACT SINCE' IS FALSE. THE AXIOM-FORM LORE: A PROFILE CERTIFIES THE TERMINAL AS PHRASED, NOT THE FACT, minted in TECHNE-Core, local, not pushed. 0 INSTRUMENTS BUILT, 0 LANES OPENED, 0 SITES REOPENED, 0 CONTENT LOST",
     "### NO GRADE MOVED, CONFERRED OR MINTED. ### THE KERNEL HALF STAYS AT K5'S EXISTING GRADE; THE COUNTING HALF IS MEASURED. ### NO SITE REOPENED, NO CELL REPLACED, NOTHING IMPORTED. ### NO CLAIM ABOUT RH, h2 OR ANY ZERO",
     'data/b441_the_identification_filed.txt; data/b441_components.txt; data/b441_routes.json; data/b441_price.json; data/b441_reach.json; data/b441_registration_2026-09-12.txt (LOCKED, 8 gates read, 4 by digest); FACES_LEDGER.md <!-- b441 update -->; OPEN_TRAILS.md; CORRESPONDENCE.md row 290'),
    # ### THE FIXED POINT NAMED, THE BREAK ATTRIBUTED, AND TWO FACTS BUILT (b440).
    ('the-fixed-point-named-the-break-attributed-and-two-facts-built', 'b440 (the fixed point named, the break attributed, and two facts built)',
     "b440 CHECKED FOUR CLAUSES ABOUT ONE CONSTANT, ATTEMPTED TWO KERNEL STATEMENTS AND BUILT NEITHER, AND READ ONE WEIGHT'S IDENTITY OUT OF THE CORPUS'S OWN DICTIONARY. COMPONENT 1, FOUR CLAUSES AND FOUR VERDICTS: u0 IS THE EXACT ROOT OF Re psi(1/4 + iu/2) = log pi, LOCATED BY TWO ROUTES THAT SHARE NO CODE agreeing to 9e-47 against a tolerance of 1e-12 stated first. h+/2pi IS THE SMOOTH ZERO-COUNTING DENSITY, AND SHARPER THAN THE CLAUSE CLAIMED: its integral is theta(T)/pi, and THE RIEMANN-VON MANGOLDT MAIN TERM IS THAT INTEGRAL PLUS EXACTLY ONE -- the pole of zeta at s = 1 -- with deficit 1/(48 pi T), BOTH LEFTOVER TERMS NAMED. BUT THE CORPUS MAKES NO SUCH IDENTIFICATION: 405 documents, 3 tight-screen lines, ALL HAND-READ AND ALL NOT A JOIN; it carries the expression as W_inf and the counting law as Riemann-von Mangoldt and JOINS THEM NOWHERE, and THE NEAREST LINE DENIES THE RELATION -- SIDE-window's own non-claim, warning that its W is a counting function UNRELATED to W_inf. AND 2 pi IS NOT u0: it is the zero of a DIFFERENT function agreeing to O(u^-2), and h+(2 pi) = -1.06e-03. DEFINING EQUATION HELD, CLASSICAL ASYMPTOTE HELD AND IT IS 2 pi, CLOSED FORM NOT HELD -- TWENTY-ONE DIGITS IS NOT A CLOSED FORM. COMPONENT 2: NEITHER FACT IS BUILT AND 0 OBJECTS WERE COMPILED, BY THE ORDER'S OWN CONDITION. The maximizer comparison reduces exactly to (log_q p)^2 > p^k/q^j, AN INEQUALITY BETWEEN A TRANSCENDENTAL AND A RATIONAL, and exponentiating only moves the irrational into the exponent. THE PROBE WAS RUN, NOT DESCRIBED: Real is an unknown identifier; Rat and Float exist and BOTH ARE OPAQUE TO decide; Nat.sqrt does not exist; and a Decidable instance for Float order DOES exist while decide still cannot close it. THE POSITIVE CONTROL PASSED AND CARRIED A RESULT THE SEAT HAD NOT PREDICTED: (primePowersLT 16).elem 16 = false HAS NO AXIOMS AT ALL, while the propositional form 16 not-in primePowersLT 16 CARRIES [propext, Quot.sound] -- 5 clean terminals and 2 carrying axioms, so THE FORM OF THE STATEMENT DECIDES WHETHER IT IS AXIOM-FREE. FACT (i) IS BUILDABLE AND IS ROUTED BACK, NOT TAKEN. COMPONENT 3: THE ORDER'S CONDITIONAL PREMISE FAILS AND THE OFFERED FINDING IS NOT STATED. The corpus's term-for-term dictionary says cosh(v/2) WEIGHTS W_pole, and the archimedean weight is Re psi(1/4 + iu/2) - log pi in a different variable. THE AIM'S SECOND MOMENT CONDITION IS THE LAWFULNESS CONDITION g-hat(i/2) = 0 -- the requirement that the test function KILL THE POLE TERM -- and cosh(v/2) = (x^(1/2) + x^(-1/2))/2 is the s <-> 1-s symmetric pair, which a dilation by c scales by EXACTLY (1 + 1/c)/2, verified to nine figures, NEVER BY A SINGLE FACTOR. THE BREAK IS STRUCTURAL AND ITS STRUCTURE IS THE FUNCTIONAL EQUATION'S POLE PAIR, NOT THE GAMMA FACTOR. b439's 2.266e-04 IS UNTOUCHED AND ONLY ITS ATTRIBUTION MOVES. THE MECHANISM SENTENCE IS A HEURISTIC AND THE ACT SAYS SO: it predicts the sign of A at 9 of 10 cells across both families and FAILS AT ONE, so THE SECOND FAMILY'S NEVER CROSSING IS NOT EXPLAINED BY THE SAME SENTENCE. TWO DEFECTS OF THIS ACT'S OWN ARE PRINTED: an undeclared write path, caught by the write-list arm; and a bisection through carto_atlas.kernel, WHICH CACHES ON ITS FIRST ARGUMENT AND IGNORES EVERY LATER ONE, caught by the tolerance stated first. 0 INSTRUMENTS BUILT, 0 FAMILIES DEFINED, 0 INSTRUMENT LANES OPENED, 0 SIDE-window FILES WRITTEN, 0 CONTENT LOST",
     '### NO GRADE MOVED, CONFERRED OR MINTED. ### NO CELL WRITTEN, NO SITE ENTERED, NO BRIDGE TYPED. ### NO NEW INSTRUMENT, NO NEW FAMILY, NEITHER INSTRUMENT LANE OPENED. ### THE KERNEL LANE OPENED TO BUILD AND NOTHING WAS COMPILED FOR THE WINDOW KERNEL. ### NO CLAIM ABOUT RH, h2, ZETA OR ANY ZERO',
     'data/b440_the_fixed_point.txt; data/b440_components.txt; data/b440_extract.txt; data/b440_u0.json; data/b440_clauses.json; data/b440_kernel_attempt.json; data/b440_density_search.json; data/b440_checks.txt; data/b440_registration_2026-09-12.txt (LOCKED, 8 gates read, 4 by digest); OPEN_TRAILS.md; CORRESPONDENCE.md row 289'),
    # ### THE FIXED PROFILE, THE FIXED POINT, AND ONE ARITHMETIC CLAIM (b439).
    ('the-fixed-profile-the-fixed-point-and-one-arithmetic-claim', 'b439 (the fixed profile, the fixed point, and one arithmetic claim)',
     "b439 ASKED THREE QUESTIONS AND REFUTED THREE OF ITS FOUR EXPECTATIONS, TWO OF THEM ABOUT WORK THIS SEAT DID TWO ACTS EARLIER. COMPONENT 1, DERIVED FROM THE CONSTRUCTION'S OWN INTEGRANDS AND THEN MEASURED: the three supports at s = 1, 1/2, 1/4, each bump's own shape in s, and the first moment condition INT phi_i dv = 1 are all scale-invariant; but the SECOND moment condition INT phi_i(v) cosh(v/2) dv becomes INT (1/e) phi(s/e) cosh(s log a / 2) ds in the scaled variable, CARRYING a EXPLICITLY INSIDE A cosh, WHICH IS NOT A POWER OF x. So the coefficients drift -- c1 spreads 6.965395e-02 across six radii -- and THE AUTOCORRELATION IS NOT A FIXED PROFILE IN s. VERDICT PARTLY, and the literal answer is NO. AND THEREFORE b438'S 2.27e-04 SPREAD IS THE OBJECT'S, NOT THE GRID'S: the profile's own zero -- THE ONE b438's CROSSINGS ACTUALLY SIT ON, matched rather than pooled -- reproduces them to 1e-14 and MOVES BY THE SAME 2.266e-04 between the same two radii. b438's 'fixed boundary' is fixed only to 2e-04, and the cosh residual b438 filed as an untested reading is now measured and is real. THIS ACT MADE b438'S OWN MISTAKE ONCE: its first writing compared the FIRST down-zero at s ~ 0.1428 against crossings on a LATER zero at s ~ 1.1623 -- two different zeros, one act after b438 pooled three -- and it is printed as this act's defect. COMPONENT 2: b438's closing wrote that the two-term's weight is 'the largest of any prime power', AND THAT IS FALSE. 2 log p / sqrt(n) over the prime powers below sixteen is maximised at n = 7 (1.470970); n = 2 is 0.980258, SIXTH OF TEN. The navigator's arithmetic was checked and agrees. It WAS load-bearing -- b438 offered it as the reason -- but THE FINDING IT SUPPORTED IS UNTOUCHED, having been established from the printed terms. b438'S BANK IS NOT EDITED. AND THE REPLACEMENT IS NEITHER CANDIDATE BUT THE PRODUCT: position predicts the largest term at 19 of 30 cells and the weight's own maximizer at 0 of 30; the 11 exceptions are all at large radius and all lost to n = 3; and at 5 of them THE SMALLEST-s TERM HAS THE LARGER AMPLITUDE AND STILL LOSES, because n = 3's weight is 1.29x n = 2's. At small radius the amplitude ratio is enormous and POSITION decides; at large radius the amplitudes converge and THE WEIGHT RATIO decides. On b438's own range (a <= 3.0, below the first exception at a = 4.795832) position holds everywhere. COMPONENT 3: u0 = 6.289835988836903, located by TWO ROUTES THAT SHARE NO CODE -- the digamma directly, and the log-derivative of the completed gamma factor through loggamma -- agreeing to 7.523e-37 against a tolerance of 1e-09 STATED BEFORE THE COMPARISON. (Not b438's pair: the atlas's A and b320's weil compute the archimedean channel of a test function and NEITHER EXPOSES THE KERNEL POINTWISE.) It is EXACTLY where h+'s two constituents balance, Re psi(1/4 + i u/2) = log pi. AND THE RECORD NAMES IT NOWHERE: ten files carry the value and ALL TEN TRACE TO b438, TO THIS ACT, OR TO WHAT THEY WROTE -- no other act mentions it -- and b438 prints it without naming it. The corpus gives h+ a closed form and proves it two ways; it gives NO CLOSED FORM for the solution, nor does any pinned source. SO THE CORPUS CAN SAY WHERE IT IS AND CANNOT SAY WHAT IT IS. COMPONENT 4 IS PRICED AND NOT OPENED: the order's conditional opened 'if Component 1 returns FIXED' and IT DID NOT, so the premise fails; the question prices as a MEASUREMENT and not a READ, because b436 found the density result absent from every verified source AND the profile is not fixed. THE MEASUREMENT IS UNBLOCKED; THE BUILD IS BLOCKED BY THE KERNEL LANE. The three finite facts are NAMED AND NOT BUILT, with the second QUALIFIED: the supports are fixed, the profile's zeros are not, so a kernel carrying 'fixed shells' would carry a falsehood.",
     '### NO GRADE MOVED, CONFERRED OR MINTED. ### NO CELL WRITTEN, NO SITE ENTERED, NO BRIDGE TYPED. ### NO NEW INSTRUMENT, NO NEW FAMILY, NO LANE OPENED. ### NOTHING COMPILED FOR THE WINDOW KERNEL. ### NO CLAIM ABOUT RH, h2, ZETA OR ANY ZERO',
     'data/b439_the_fixed_profile.txt; data/b439_components.txt; data/b439_extract.txt; data/b439_profile.json; data/b439_weights.json; data/b439_u0.json; data/b439_registration_2026-09-12.txt (LOCKED, 8 gates read, 4 by digest); OPEN_TRAILS.md; CORRESPONDENCE.md row 288'),
    # ### WHAT ALTERNATES THE SIGN, AND WHERE THE ROOM CLOSES (b438).
    ('what-alternates-the-sign-and-where-the-room-closes', 'b438 (what alternates the sign, and where the room closes)',
     "b438 EXECUTED (R49) IN ITS OWN SCOPE -- the cells b437 banked, decomposed, and the archimedean distribution evaluated against the same family -- WITH NO NEW INSTRUMENT, NO NEW FAMILY AND NO NEW CELL. THE LADDER RIDES AN AIMED SEED, NOT THE PLAIN BUMP: three of the corpus's own bumps at widths a, a^(1/2), a^(1/4) with two coefficients SOLVED so two moments vanish, and a non-negative function cannot have a vanishing integral unless it is zero, so THE SEED MUST TAKE NEGATIVE VALUES AND THE OSCILLATION IS BUILT IN BY THE AIM. 298 TERMS PRINTED ACROSS 35 CELLS. (N1) WAS AN IDENTITY AND THE FACE SAID SO BEFORE A CELL WAS SPENT -- 2 log p / sqrt(n) is strictly positive, so the sign of a term IS the sign of the test function at that log by the FORM of the expression; the author has since withdrawn it as an identity and the withdrawal is recorded, not re-scored. WHAT ACTUALLY ALTERNATES THE SIGN IS NOT THE ENTERING PRIME POWER, AND CANNOT BE: a prime power enters at p^k = a^2, the SUPPORT EDGE, where the bump vanishes. At the two flips the arrival contributes +4.81e-05 and +1.16e-10 while the already-present terms move by -3.08e-02 and +1.49e-01 -- factors of 6e+02 and 1e+09. THE n = 2 TERM FLIPS AND THE SUM FOLLOWS IT; its weight 2 log 2 / sqrt 2 = 0.980258 is the largest of any prime power and log 2 sits deepest inside the support. THE ADDENDUM'S COLUMN ANSWERS SHELL CROSSING ON BOTH CLAUSES: an already-present term changes sign at BOTH flips with the entering term carrying 0 of 2, and the two DOWNWARD crossings -- n = 2 at a* = 1.8155451 and n = 3 at a* = 2.5729801, different primes at different radii -- give log n / log a* of 1.162246350 and 1.162472952, agreeing to 2.266e-04. That is a FIXED BOUNDARY in s = v / log a, and the third crossing (n = 2 going up, at s = 0.754061238) is a SECOND ZERO OF THE SAME FIXED SHAPE. b437's (N1) coincidence is restated as a coincidence of two cells. AND THIS ACT'S FIRST WRITING OF THAT TEST POOLED ALL THREE AND REPORTED A SPREAD OF 0.408, COMPARING ONE ZERO AGAINST ANOTHER -- the defect is named rather than carried. THE ROOM CLOSES AT a0 = 5.6416382, root-found and not gridded, bracketed to 2.7e-06, by TWO ROUTES THAT SHARE NO CODE differing by 3.886e-06 against a tolerance of 1e-04 stated before the comparison. THE ZERO BELONGS TO THE INTERACTION: h+ has ONE sign change at u0 = 6.289835989 which does not move with a; the seed's L1 scale is exactly 1.000000000 at every radius and a positive number moves no zero; and the transform mass below u0 runs 0.057, 0.207, 0.390, 0.499, 0.523, crossing one half at a0. THE SECOND FAMILY -- corpus_bump's autocorrelation, NOT LAWFUL and carrying no criterion reading -- never crosses at all between a = 2 and a = 12, which settles the question in the stronger direction. PAST THE ROOM THERE IS EXACTLY ONE CELL and (R49) authorises no more: at a = 5.656854 the archimedean slack is negative and THE PRIMES CARRY THE CRITERION BY THEMSELVES, with SUM_v W_v = -0.038231 <= 0. AND THE COST IS RESTATED: THE ZERO SIDE IS INHERITED, summed over ordinates all ON the line, so satisfaction is ASSUMED AND NOT TESTED. NO CLAIM ABOUT ZEROS. b432's disproof-lane trigger fired at (R48) and its disposition waits on the author; this act does not open it.",
     "### NO GRADE MOVED, CONFERRED OR MINTED. ### NO CELL WRITTEN, NO SITE ENTERED, NO BRIDGE TYPED. ### NO NEW INSTRUMENT, NO NEW FAMILY, NO NEW CELL. ### NO CLAIM ABOUT RH, h2, ZETA OR ANY ZERO. ### THE INSTRUMENT LANE CLOSES AT THIS ACT'S END",
     'data/b438_the_alternation_and_the_room.txt; data/b438_components.txt; data/b438_extract.txt; data/b438_terms.json; data/b438_room.json; data/b438_registration_2026-09-12.txt (LOCKED, 8 gates read, 4 by digest); OPEN_TRAILS.md; CORRESPONDENCE.md row 287'),
    # ### THE WINDOW OPENED BY RUNGS (b437).
    ('the-window-opened-by-rungs', 'b437 (the window opened by rungs)',
     "b437 EXECUTED (R48) -- THE WINDOW IS OPENED BY RUNGS -- along SIDE-window's compiled ladder, on the same instrument, building none. TWENTY-TWO NEW CELLS past the record's last, each carrying its own identity residual as its control: 0 failed the identity, 0 had a non-zero pole term, 0 had a negative zero side. THE LADDER AND b321'S THIRTEEN CELLS ARE JOINED FOR THE FIRST TIME, by the ladder's own STRICT count W(a^2) -- and the join corrected a convention before it was used: a prime power sitting exactly at a^2 lands on the support EDGE where the bump vanishes, so its term is identically zero, the ladder's W 9 = 6 and the instrument's six terms agree, and a rung is entered CONTINUOUSLY. THE SIGN QUESTION, AS A MEASUREMENT: both sign changes bracket exactly one boundary each (n = 3 at a = 1.7321, n = 7 at a = 2.6458) AND 4 of 6 boundaries are crossed with NO sign change -- the coincidence runs ONE WAY ONLY and is reported as running one way only. THE RATIO CLIMBS TO 0.875425 AT a = 4.000000 AND THEN FALLS. The four cells where |PR|/A exceeds one are THE ARCHIMEDEAN CHANNEL COLLAPSING THROUGH ZERO -- A runs 0.0199, 0.0125, 0.0055, 0.0022 and passes through zero at a = 5.656854 where A = -0.001104564 -- AND NOT THE PRIME CONSTITUENT OVERTAKING IT. THE CRITERION IS SATISFIED EVERYWHERE ON THE LADDER: SUM_v W_v = PR - A is non-positive at all 35 cells. AND THE LOCKED FACE SAID BEFORE ANY VALUE EXISTED that PR/A > 1 on the positive branch is the same statement as Z < 0, that Z is a sum of non-negative terms over ordinates ALL ON THE LINE and cannot be negative, and that THE POSITIVITY IS ASSUMED AND NOT TESTED -- an instrument summing only on-line ordinates cannot report the case the criterion exists to detect. THE FLOOR WAS PRICED PAST THREE RADII FOR THE FIRST TIME, at 3 radii around the crossing on a doubled grid, and RESOLVES -- so the crossing is NOT undecided at the instrument's edge; it is undecided because A is going to zero, which the record does not interpret. AND b432'S DISPROOF-LANE TRIGGER CONDITION IS MET BY THIS LANE OPENING, IS NAMED ON THE FACE, AND THE LANE IS NOT OPENED -- (R48) reaches the window ladder only and the disposition is the author's.",
     "### NO GRADE MOVED, CONFERRED OR MINTED. ### NO CELL WRITTEN AND NO SITE ENTERED. ### NO NEW INSTRUMENT BUILT AND NO INSTRUMENT FILE EDITED. ### NO CLAIM ABOUT RH, h2 OR ZETA. ### THE INSTRUMENT LANE CLOSES AT THIS ACT'S END",
     'data/b437_the_window_by_rungs.txt; data/b437_components.txt; data/b437_extract.txt; data/b437_rungs.json; data/b437_cells.json; data/b437_registration_2026-09-12.txt (LOCKED, 8 gates read, 4 by digest); SIDE-window SIDEWindow/Ladder.lean; OPEN_TRAILS.md; CORRESPONDENCE.md row 286'),
    # ### THE WITNESS ARC AT SITE (iv), THE WINDOW (b436).
    ('the-witness-arc-at-site-iv-the-window', 'b436 (the witness arc at site (iv), the window)',
     "b436 WORKED SITE (iv) OF ROW U1 -- THE WINDOW -- AND ENUMERATED 7 CANDIDATES, 0 HELD. THE OBJECT WAS DECLARED A UNIFORM BOUND BEFORE THE FIRST CANDIDATE: this site's cell reads UNSTATED and not NONE KNOWN, because its record holds TEN MEASURED VALUES indexed by the width rather than ten existential witnesses, and b406 established that the existential anyone can manufacture is trivially satisfiable, so the shared witness it would demand IS the missing statement rather than a repair for its absence. Every candidate failed at a step quoted at its own file and line: Lagarias Theorem 6.1 at a CLASS BOUNDARY on b401's three grounds; the source's Theorem 6.11 at a COORDINATE BOUNDARY, its c|ghat(0)|^2 with 13<c<17 correcting the archimedean inequality at a support where NO PRIME ENTERS and where b321 prints the quantity it would bound as identically zero; the source's named one-prime widening ABSENT, named and not taken; the corpus's own window and kernel terminals at INSTANCES NOT A CLASS, the terminal's own name being SmearGeneral.cells_are_instances; the criterion itself at FORM, asserting a sign on the TOTAL and bounding no constituent; and the Vinogradov-Korobov shrinkage law IMPORT UNDER THE BAR and indexed by the height where this site is indexed by the width. THE NAVIGATOR'S ELEMENTARY CHEBYSHEV-MERTENS BOUND WAS TESTED IN TWO PARTS AND NOT ADOPTED ON HIS WORD. His paraphrase is ACCURATE against (149). Part (a): LOCATED AS ELEMENTARY, and NOT LOCATED AS A BANKED STATEMENT -- no verified source states it, the Chebyshev psi vocabulary sits only in internal/, which the corpus classes REGISTRY-silent working logs scoped census-only, and the one psi statement there is CONDITIONAL ON RH. Part (b): IT RUNS THE WRONG WAY. At b321's ten cells the archimedean quantity FALLS 4.372801 to 0.506677 while the prime constituent GROWS in absolute value 0.000063 to 0.190861, the ratio climbing 1.435e-05 to 3.767e-01 across ten cells -- so no bound uniform in a can show the prime side staying dominated, because the thing it bounds is itself climbing toward the thing it would have to stay under. AND THE TWO SIDES ARE COMPARABLE, NOT INCOMMENSURABLE: they are two of the four channels of one identity Z = P - PR + A which b321 verified at ALL THIRTEEN CELLS, the archimedean channel built a second time by a route sharing no code and agreeing to 6.118e-05. THE CROSSING IS UNDECIDED BECAUSE THE RECORD'S WINDOW ENDS AT a = 3.0, NOT BECAUSE THE QUANTITIES WERE NEVER NORMALIZED -- and what would decide it is one run of the window instrument at larger radii, blocked by the parked instrument lane. AT FOUR SITES: 6 of 7 failures land at a boundary an earlier site used, the union of kinds grows from 10 to 11, and ONE KIND IS NEW -- WRONG DIRECTION, where the object exists, is uniform, is unconditional and is about the right sum, and moves the wrong way against the quantity it must be compared with. NO CELL WAS WRITTEN, the register stays FROZEN AT SIX, and NO BRIDGE IS TYPED BETWEEN ANY TWO OF THE SIX.",
     '### NO GRADE MOVED, CONFERRED OR MINTED. ### NO CELL WRITTEN AND NO SITE ENTERED. ### NO BRIDGE TYPED. ### NO INSTRUMENT WRITTEN -- BOTH LANES PARKED. ### NOTHING DEPOSITS',
     'data/b436_the_window.txt; data/b436_components.txt; data/b436_extract.txt; data/b436_candidates.json; data/b436_two_sides.json; data/b436_registration_2026-09-12.txt (LOCKED, 8 gates read, 4 by digest); OPEN_TRAILS.md; CORRESPONDENCE.md row 285'),
    # ### THE CURE SHARED, AND THE SKIPS THAT PRINT LIKE PASSES (b435).
    ('the-cure-shared-and-the-skips-that-print-like-passes', 'b435 (the cure shared, and the skips that print like passes)',
     "b435 EXECUTED (R46) -- A CURE THAT LIVES IN ONE TOOL IS NOT A GUARD -- AND EXTENDED IT NOWHERE. b314's read-only handler, written at b314 and never shared, was quoted at its own file and line (tools/b314_coldclone.py:47) and EXTRACTED to tools/force_rm.py with FIXTURES IN BOTH POLARITIES: a read-only tree removed, and a genuine failure still raising -- plus a CONTROL showing the bare rmtree refuses that same tree, so the positive fixture is not vacuous. 2 of 10 call sites were repointed and 8 were NAMED AND LEFT with their reasons; the three guard sites (b376_lockgate, b378_lockgate, gate_hash) are on their own rows and all three are left, so NO GATE CHANGED A BYTE. THE CALL ON EACH SITE IS THE SEAT'S AND IS SAID TO BE: three successive mechanical rules each mis-sorted a site, and a derivation that keeps changing its answer is not a measurement. COMPONENT 2: b304_hooks.py already said SKIPPED in the row and then folded that state into the failure total, so the same 1 read as a failure in one table and as an exercised guard in another. The skip now has its own count, the VERDICT line names all three states, and THE EXIT CODE CAN NO LONGER SAY 0 ON A SKIPPED RUN -- which, left alone, would have MINTED b434's own species while curing it. COMPONENT 3, THE CENSUS, RUN ONCE AND REPAIRING NOTHING: 11 candidates by description, 8 genuine single-tool environmental handlers after hand-reading, and the largest family is an encoding or an EOL -- the same machine condition met INDEPENDENTLY by 6 acts (b302, b304, b313, b319, b364, b369). W-REMOVAL-VERIFIED is DISCHARGED, its own trigger having fired. AND ONE BREACH PRINTED RATHER THAN REPAIRED: this act's locked face named the repointed sites as a CLASS where (R44) requires a name, the write ledger refused it, and the face was NOT edited.",
     "### NO GRADE MOVED, CONFERRED OR MINTED. ### NO KEYSTONE EDITED. ### NO RESEARCH INSTRUMENT TOUCHED. ### THE INSTRUMENT LANE WAS OPEN FOR THE GUARD LAYER ONLY AND CLOSES AT THIS ACT'S END. ### NOTHING DEPOSITS",
     'data/b435_the_cure_shared.txt; data/b435_components.txt; data/b435_extract.txt; data/b435_checks.txt; data/b435_registration_2026-09-12.txt (LOCKED, 8 gates read, 4 by digest); tools/force_rm.py; OPEN_TRAILS.md; CORRESPONDENCE.md row 284'),
    # ### THE EXTERNAL-GRADING ARC, FOLDED (b434).
    ('the-external-grading-arc-folded', 'b434 (the external-grading arc, folded)',
     "b434 FOLDED THE EXTERNAL-GRADING ARC, b423 THROUGH b432, INTO FINDINGS.md -- PURELY ADDITIVE, 70 insertions and 0 deletions, the committed text a true prefix. THE SPAN IS b363_span.py'S: last fold b413-b421 filed by b422, next span starting at b423, raw count 12 through this sortie's own two acts, AND THE SPAN FILED IS TEN; both figures printed. 10 of ten grade strings were verified in their own acts' closing banks before the fold stated them. THE ARC IN ONE STATEMENT: the corpus turned its grading discipline outward for the first time and the discipline held, while the same protocol turned inward found the corpus's own prose claiming more than its terminal proves -- five findings side by side with 0 words of supersession between them. b412's third column kept apart: 0 statements about the object, 5 about the record, 0 new about the object's model. ONE SPECIES MINTED: A TOOL ASKED NOT TO COMPLAIN REPORTS A SUCCESS IT DID NOT EARN, with b414's over-budget decide, b418's search at its time limit and b433's silent delete named from their own banks, and the shared cure -- the verdict is read from the object, never from the exit code. b414 and b418 carry mechanized guards (the printed profile; the shared walker_guard.py); b433 does not, and THE CURE FOR IT ALREADY EXISTED AT b314 AND WAS NEVER SHARED -- a cure that lives in one tool is not a guard. W-REMOVAL-VERIFIED filed with its trigger and NOT started. A TECHNE module written beside the species, local and not pushed.",
     '### NO GRADE MOVED, CONFERRED OR MINTED. ### NO BYTE OF WHAT IT FOLDS WAS EDITED. ### NO LANE OPENED. ### NOTHING DEPOSITS. ### TECHNE NOT PUSHED',
     'data/b434_the_fold.txt; data/b434_components.txt; data/b434_fold.json; data/b434_span.txt; data/b434_registration_2026-09-12.txt (LOCKED, 8 gates read, 4 by digest); FINDINGS.md; OPEN_TRAILS.md; TECHNE-Core modules/2026-09/ASKED_NOT_TO_COMPLAIN.md (local); CORRESPONDENCE.md row 283'),
    # ### THE FIVE RULINGS EXECUTED (b433).
    ('the-five-rulings-executed', 'b433 (the five rulings executed)',
     "b433 EXECUTED FIVE AUTHOR RULINGS AS REPAIRS TO THE RECORD, EACH MEASURED AGAINST A PRE-ACT BLOB PINNED BY sha256 BEFORE THE FACE WAS TYPED. %s applied, %s not located, %s refused; every per-file delta non-negative and every original still findable. (R41): NOT THE CLAIM is DEFINED in both documents that define the corpus's grades -- README.md and EXCLUSION_ENGINE.md section 0 -- additively, the three existing bullets untouched, each heading corrected with its old words quoted beneath it, and b429's and b430's incidents cited. (R42): the conspiracy keystone is annotated in its own document's form -- the compiled crt_exhaustiveness is a periodic lift at a SINGLE modulus and invokes no Chinese Remainder Theorem -- and THE LEMMA IS NOT RENAMED; the original sentence survives word for word. (R43): K3's two rows and F5's claim-bearing row are marked to what SmearGeneral.smear_general states, the model's count over single-prime-factor bases, with K3's named objects KEPT as what the source's trace would require and MARKED as not carried by the terminal; F5's scope clause was NOT rewritten because it is true of the terminals that row lists, and that reading was declared on the locked face before the act touched anything. The disproof lane's trail entry gained the form-(b) finding with the barrier keystone's T1 symmetry clause quoted beside it and the sentence that the instruments are not symmetric though the theory is; the lane stayed shut. (R44): b432's write-list form is standing. (R45): the external clone is removed, after its substitutes were confirmed present and tracked. 0 grades moved, 0 terminals renamed, 0 kernels built, 0 premises discharged.",
     '### NO GRADE MOVED, CONFERRED OR MINTED. ### NO TERMINAL RENAMED. ### NO LANE OPENED. ### NO PREMISE DISCHARGED. ### NOTHING DEPOSITS',
     'data/b433_the_five_rulings.txt; data/b433_components.txt; data/b433_repairs.json; data/b433_preact_blobs.txt; data/b433_registration_2026-09-12.txt (LOCKED, 8 gates read, 4 by digest); README.md; EXCLUSION_ENGINE.md; ADDITIVE_MULTIPLICATIVE_CONSPIRACY.md; FINDINGS.md; FACES_LEDGER.md; OPEN_TRAILS.md; CORRESPONDENCE.md row 282'),
    # ### THE LongGapsBetweenPrimes GRADING (b431).
    ('the-disproof-lane-restated', 'b432 (the disproof lane restated with a worked case)',
     "b432 RESTATED THE DISPROOF LANE WITH A WORKED CASE OF EACH SHAPE AND OPENED NOTHING. The lane was named at b428 with no example of a graded disproof; the sortie produced two. CASE A: %s -- b429 against Clay C, whose conclusion is a UNIVERSAL NEGATIVE. CASE B: %s -- b431 against Theorem 1.1, an EXISTENTIAL construction. Both grades are the same word and the statements are of opposite shape. THE TWO FORMS a disproof of h2 could take, in the corpus's own vocabulary: (a) an exhibited zero off the line, which must meet the barrier keystone's T6 -- Re F = Im F = 0, codimension 2; (b) the universal negative that no on-line arrangement is consistent with the balance, which exhibits nothing. Form (b) has b429's shape, form (a) has b431's. BOTH NAMED INSTRUMENTS SERVE FORM (a): the negative control is run on the Epstein zeta whose off-line zeros are proved and exhibited, and reports whether the instrument sees one (b325 DOES NOT SEE IT, b328 SEES IT at seven of eight); the phase condition is stated AT AN OFF-LINE QUADRUPLE and is the calibration that decides whether the control can fire at all. SO THE CORPUS HAS NO INSTRUMENT POINTED AT FORM (b) AT ALL -- which sharpens b428's finding: the instrument it has is of the WRONG KIND for one of the two forms, not merely unpointed. Not a claim that form (b) is unreachable. Neither form asserted, neither constructed, trigger untouched. Cited in no corpus document.",
     '### NO LANE OPENED. ### NO TRIGGER MOVED. ### NO CANDIDATE CONSTRUCTED. ### NO GRADE MOVED. ### NO KEYSTONE EDITED. ### NOTHING DEPOSITS',
     'data/b432_the_disproof_lane.txt; data/b432_components.txt; data/b432_forms.json; data/b432_registration_2026-09-12.txt (LOCKED, 8 gates read, 4 by digest); OPEN_TRAILS.md; CORRESPONDENCE.md row 281'),
    # ### THE LongGapsBetweenPrimes GRADING (b431).
    ...
    ('the-ruling-carried', "b418 (R35 executed, the walker's miss traced to a silent timeout and guarded, three repairs, and (N) attempted to OVER-BUDGET with one helper unsupplied)",
     ...
     '### NO KERNEL FILE TOUCHED, NO TERMINAL ADDED, NO GRADE MOVED, NO PREMISE DISCHARGED. ### THE THEOREM IS NOT CLAIMED. ### NOTHING DEPOSITS',
     'data/b418_the_ruling_carried.txt; data/b418_components.txt; data/b418_walker.txt; data/b418_n_attempt.txt; data/b418_registration_2026-09-11.txt (LOCKED, 8 gates read, 4 by digest); tools/walker_guard.py; tools/retired/RETIRED.md; CORRESPONDENCE.md row 267'),
    # ### THE CONTRADICTION PUT (b417).
    ('the-contradiction-put', "b417 (the formation contradiction put to its owner with both readings priced and neither adopted, the second dated tool repaired and run snapshot first, the species minted, the Core caveats marked, and one clause added to the Reader's head under (R33))",
     "b417 PUT THE CONTRADICTION TO ITS OWNER AND CLEARED THE SECOND TOOL. **THE OWNER'S UNIVERSALITY SENTENCE AND THE KERNEL'S TUPLES ARE SET SIDE BY SIDE AS A DEFECT REPORT**, both halves in MATTER_AS_ARITHMETIC; under (R34) **THIS SEAT SAYS NEITHER HALF IS WRONG**. **TWO LIVE DOCUMENTS CITE THE SENTENCE** (the owner and AT_REST) **AND FIVE CITE THE DISAGREEING TUPLES WITHOUT IT**. **n2 = 2 IS LOAD-BEARING FOR BOTH B AND D.** **READING (a) MAKES B EQUAL C AND D EQUAL A -- FOUR NAMED CLASSES BECOME TWO DISTINCT TUPLES -- AND FALSIFIES classA_distinct_from_classD; READING (b) MOVES NO FIGURE; CLASS A'S 4/81 IS UNMOVED UNDER BOTH.** **(N4) IS MET IN PREMISE AND NOT IN CONCLUSION: THE HEADER IS THE SAME HALF STATED TWICE.** **(N5) IS REFUTED.** **b369_hygiene.py WROTE NOTHING WHILE BROKEN**; repaired and **RUN AGAINST A CAPTURED SNAPSHOT FIRST**, its writes **ESCAPED AS ONE OBJECT EACH INTO THREE OTHER REPOSITORIES' STORES**; live, three prior-act records rewritten and restored; its verdict reported, not edited. **THE SPECIES SAFE_BY_BEING_BROKEN IS FILED LOCAL, NOT PUSHED**, mechanized as tools/repair_snapshot.py, **WHICH FOUND A DEFECT IN ITSELF ON ITS FIRST LIVE USE**. **ONE CAVEAT TESTED, TWELVE UNTESTED.** The placed Reader's head note grew one clause under (R33); its body is byte-identical.",
     '### NO `.lean` FILE TOUCHED, NO BUILD RUN, NO TERMINAL ADDED. ### NO GRADE MOVED CONFERRED OR MINTED, NO PREMISE DISCHARGED, NO DOOR RESTATED, NO KAPPA MEASURED, NO ROUTE PROPOSED, NO LEDGER ROW WRITTEN, NO FOLD RUN, NO RULE STRUCK OR AMENDED, NO REGISTRY ROW WRITTEN. ### NEITHER HALF OF THE CONTRADICTION EDITED OR RULED ON. ### NOTHING DEPOSITS AND THE PLATFORM WAS NOT CALLED AT ALL',
     'data/b417_the_contradiction_put.txt; data/b417_components.txt; data/b417_extract.txt; data/b417_snapshot.txt; data/b417_live.txt; data/b417_registration_2026-09-11.txt (LOCKED before any write, chained on tools/b378_lockgate.py run as b417 -- 8 gates read, 4 checked by digest); tools/b417_components.py; tools/repair_snapshot.py; tools/b369_hygiene.py; PLACE-papers heritage/PRIME_CORE_READER.md, OPEN_TRAILS.md; CORRESPONDENCE.md row 266'),
    # ### THE READER PLACED (b416).
    ('the-reader-placed', "b416 (n1 and n4 named from their owner, the universality sentence found to contradict the kernel's own tuples, deriving n1 priced, the dated hook instrument repaired twice over, the (T1.4) annotation drafted and withheld, and the Prime Core Reader placed under (R32) with its two defects reported and neither repaired)",
     "b416 NAMED THE TWO STIPULATIONS, REPAIRED THE DATED INSTRUMENT AND PLACED THE READER. **n1 COUNTS THE INDEPENDENT ALGEBRAIC CHANNELS THROUGH WHICH THE SPECIFICATION ACCESSES THE SUBSTRATE; n4 COUNTS THE MECHANISM CLASSES CONTRIBUTED BY THE BINDINGS BETWEEN STAGES**, both from MATTER_AS_ARITHMETIC section I; **NEITHER HAS EVER HAD A DERIVATION ROUTE PRICED**. **(N1) SPLITS**: n4 does count something the model asserts empty, but three documents argue it and **THE OWNER NAMES SCHUR'S LEMMA** -- **THE UNARGUED COMPONENT IS n1, AND IT IS UNARGUED BECAUSE THE OWNER DECLARES IT FREE**. **AND THE OWNER'S UNIVERSALITY SENTENCE AND THE KERNEL'S DECLARATIONS DISAGREE**: the owner calls n2 universal at 3 and the kernel declares classB.n2 = classD.n2 = 2. **A UNIVERSAL REASON CANNOT DERIVE A COMPONENT IN A CLASS WHERE THAT COMPONENT HAS ANOTHER VALUE**, so **WHAT b415 RECORDED AS AN ABSENCE IS A CONTRADICTION** -- the stipulation is not laziness, **THE TUPLES CONTRADICT THE UNIVERSALITY CLAIM THAT WOULD HAVE DERIVED THEM**. **DERIVING n1 AT CLASS A PRICES AT AT LEAST TWO ACTS AND THE FIRST IS NOT A BUILD**: the corpus must first say what an algebraic channel IS, because **THE COMPILED 2 COUNTS PRIMES AND n1 COUNTS CHANNELS** and (R28) forbids wiring them; and it may be unbuildable, since **A DERIVATION OF THE CLASS LABEL WOULD COLLAPSE THE FOUR CLASSES INTO ONE**. **b371_hookpath.py WAS REPAIRED TWICE OVER** -- the retired path, then the SameFileError the path change exposed: **REPOINTING IT REVEALED A DEFECT IT HAD BEEN HIDING**. And running it modified a prior act's record, captured and restored, **0 STILL DIFFERING** -- **A LIVE TOOL'S WRITES ARE THE REPAIRING ACT'S WRITES**. The search found 7 static hits in 5 files and **2 REAL BREAKS**, because **A FILE THAT NAMES A RETIRED PATH IN ORDER TO RECORD RETIRING IT IS NOT A DATED TOOL**; b369_hygiene.py is ROUTED. **THE (T1.4) ANNOTATION IS DRAFTED AND NOT APPLIED**, +4 lines and 0 removed, proved by the seal's sha256 being identical before and after. **13 CAVEATS OF THAT SHAPE ACROSS Core/ IN 9 FILES, 8 OUTSIDE THE SEAL, COUNTED AND NOT GRADED.** **THE READER IS PLACED UNDER (R32)** at heritage/PRIME_CORE_READER.md as Tier N of the theory-space cluster, located BY DIGEST, **BODY BYTE-IDENTICAL AND 0 BYTES EDITED**, registry row p2-35. **TWO DEFECTS FOUND IN IT AND NEITHER REPAIRED: 51 EM-DASHES CARRY cp1252 DAMAGE AGAINST 25 CLEAN, AND ITS ARITHMETIC-DESERT SENTENCE IS FALSE** -- six sum-of-powers primes lie between 41 and 137, and **THE READER'S OWN PREDICTIONS SECTION NAMES TWO OF THEM**. **THE LATTICE IS DRAWN AS A FIGURE AND CARRIES NO GRADE.** And **FORTY-THREE IS NOT THE ONLY ONE P EXCLUDES BELOW 100: THERE ARE SEVEN** -- 43, 59, 67, 73, 83, 89, 97.",
     '### NO `.lean` FILE TOUCHED, NO BUILD RUN, NO TERMINAL ADDED. ### NO GRADE MOVED CONFERRED OR MINTED, NO PREMISE DISCHARGED, NO DOOR RESTATED, NO KAPPA MEASURED, NO ROUTE PROPOSED, NO LEDGER ROW WRITTEN, NO FOLD RUN, NO RULE STRUCK OR AMENDED, NO ORIENTATION-LAYER LINE EDITED, NO LOCKED FACE OR PRIOR BANK EDITED. ### NO BYTE OF THE PLACED BODY EDITED, NO ANNOTATION APPLIED TO THE SEALED FILE, NO CONTINUATION FILE WRITTEN OR ADOPTED, NO TOOL REPAIRED THAT THE WRITE LIST DOES NOT NAME. ### NOTHING DEPOSITS AND THE PLATFORM WAS NOT CALLED AT ALL. ### NOTHING WAS PROVED AND NOTHING WAS COMPILED',
     'data/b416_the_reader_placed.txt; data/b416_components.txt; data/b416_extract.txt; data/b416_place.txt; data/b416_figure.txt; data/b416_registration_2026-09-11.txt (LOCKED before any write, chained on tools/b378_lockgate.py run as b416 -- 8 gates read, 4 checked by digest); tools/b416_extract.py; tools/b416_components.py; tools/b416_desk_bank.py; tools/b416_checks.py; PLACE-papers heritage/PRIME_CORE_READER.md, REGISTRY.md p2-35, outputs/prime-core-lattice-b416.svg, OPEN_TRAILS.md; CORRESPONDENCE.md row 265'),
    # ### THE SUBSTRATE AT GRADE (b415).
    ('the-substrate-at-grade', "b415 (the substrate keystone read at grade, the four tuples taken from the kernel's own declarations, the sibling's two ratios screened by enumeration, the experiment priced, and the drive's sibling programmes enumerated to zero)",
     "b415 READ THE SUBSTRATE AT GRADE AND SCREENED THE SIBLING'S PARTITION. **A READ ACT** -- 0 .lean files touched, 0 builds run, 0 terminals added. **THE THREE SELECTION PRINCIPLES AT GRADE: COMPLETE IS COMPILED** (FrobeniusCalibration.g_two_three, axiom-free), FINITE is NAMED and carries no terminal in this keystone, PRODUCTIVE is MIXED BY GARMENT. **THE NON-EXTENSION IS TWO CLAIMS AND ONLY ONE IS COMPILED**: element_obstruction is axiom-free and named, but **THE DIMENSION-COUNT CLAUSE THAT ACTUALLY SAYS THE SUBSTRATE DOES NOT EXTEND CARRIES NO KERNEL NAME AND IS MANUSCRIPT-RESIDENT** -- **A HEADING THAT SAYS AT THEOREM GRADE IS NOT A THEOREM**. **AND *NO OTHER PAIR SATISFIES ALL THREE* IS A MANUSCRIPT ARGUMENT FOR EACH CONJUNCT AND AN ASSERTION FOR THE CONJUNCTION.** **ALL FOUR FORMATION TUPLES ARE LITERAL defs: B, C AND D CARRY 0 DERIVED COMPONENTS BETWEEN THEM, AND CLASS A CARRIES ONLY 2 OF 4** -- n2 from Ostrowski's classification of the places, n3 from the output-stage cardinality, **n1 AND n4 STIPULATED IN EVERY CLASS INCLUDING THE ONE THE PROGRAMME RESTS ON**. SIDEKernel.formation is an arithmetic identity over four numbers, not a derivation of them, so **THE RIGHT SENTENCE IS HALF OF A IS DERIVED AND NOTHING ELSE IS**. **BOTH SIBLING RATIOS SCREEN AS PERMITTED, BY ENUMERATION**: the amplitude is one of 16 and the sign rate one of 6 that their own shapes admit over the same two primitives, with nothing named that selects them -- **AN EXPONENT NOBODY DERIVED IS AN EXPONENT SOMEBODY CHOSE**. The standard is the corpus's own, which graded its structural fraction's components **IDENTIFIED RATHER THAN FITTED** and kept the 11/12 derivation open. **PERMITTED IS NOT A REFUTATION** and a second witness is named for each. **THE EXPERIMENT IS PRICED AT TWO ACTS WITH THE CONTROL FIRST AND NOT RUN**; the matched-density randomiser is the part the corpus does not bank, and b399 is why that matters. **THERE ARE 0 SIBLING PROGRAMMES ON THIS DRIVE** -- three passes yielding 46, 2 and 0, all printed, because **A TEST THAT MAKES EVERY SUBDIRECTORY OF THE SUBJECT A PEER OF THE SUBJECT IS COUNTING READMEs**. **SO THE SCREEN RAN AGAINST THE FERRY'S OWN QUOTATION AND NO SIBLING DOCUMENT WAS OPENED, BECAUSE THERE WAS NONE TO OPEN.** The prime core searched by description under a control that holds: **THE CORPUS CARRIES EXACTLY ONE SUCH SET AND IT IS NOT CALLED A PRIME CORE -- IT IS CALLED THE SUBSTRATE**, and the Chthonic Axioms are a section of this programme's own CONVERGENCE.md rather than a sibling's state document. **THE MEMORY INDEX WAS SHORTENED 30462 -> 23054 BYTES, 118 HOOKS, 0 REMOVED, 0 FAILING TO RESOLVE AFTER THE WRITE.**",
     '### NO `.lean` FILE TOUCHED, NO BUILD RUN, NO TERMINAL ADDED. ### NO GRADE MOVED CONFERRED OR MINTED, NO PREMISE DISCHARGED, NO DOOR RESTATED, NO KAPPA MEASURED, NO CHANNEL OPENED, NO ROUTE PROPOSED, NO LEDGER ROW WRITTEN, NO FOLD RUN, NO ORIENTATION-LAYER LINE EDITED, NO RULE STRUCK OR AMENDED, NO LOCKED FACE OR PRIOR BANK EDITED, NO EXPERIMENT RUN. ### NO FILE OF ANY SIBLING PROGRAMME WRITTEN, EDITED OR QUOTED INTO A CORPUS DOCUMENT, AND NO SIBLING CLAIM ADOPTED. ### THE INSTRUMENT AND INSTRUMENT-AUDIT LANES STAY PARKED. ### NOTHING DEPOSITS AND THE PLATFORM WAS NOT CALLED AT ALL. ### NOTHING WAS COMPILED AND NOTHING WAS PROVED',
     'data/b415_the_substrate_at_grade.txt; data/b415_components.txt; data/b415_extract.txt; data/b415_programmes.txt; data/b415_memory.txt; data/b415_registration_2026-09-10.txt (LOCKED before any write, chained on tools/b378_lockgate.py run as b415 -- 8 gates read, 4 checked by digest); tools/b415_extract.py; tools/b415_components.py; tools/b415_desk_bank.py; tools/b415_checks.py; PLACE-papers OPEN_TRAILS.md; CORRESPONDENCE.md row 264'),
    # ### THE PREDICATE NAMED (b414).
    ('the-predicate-named', "b414 (the single-prime-factor predicate compiled in the axiom-free module, the general clause stated as a named open statement and not proved, the refutation moved into the kernel, and the kernel's own caveat found to name the wrong condition)",
     "b414 STATED THE PREDICATE AND LEFT THE PROOF OPEN. **THIS LEG BUILDS IN THE KERNEL** -- one new module Core/SinglePrimeFactor.lean with 15 terminals, **EVERY ONE AXIOM-FREE AT ITS PRINTED PROFILE**, and **0 EXISTING .lean FILES EDITED**. **THE MODULE QUESTION WAS RULED BY A BUILD:** the ferry's strikeable ruling fires on its FIRST limb because singlePrimeFactor compiles in the axiom-free module with no Mathlib, so the statement stays in Core/ -- **AND THE NAVIGATOR'S (N5) IS REFUTED WITH ITS REASON INTACT**, since it IS a new primitive in a module defined by having none. Core/ carried **NO PRIME NOTION IN ANY FORM**: three declarations carry a prime stem in their NAME and **NOT ONE DECIDES PRIMALITY**. **THE GENERAL CLAUSE -- for every p with singlePrimeFactor p and every n, ballQ p n * sumAN p n = sumAQ p n -- IS A NAMED OPEN STATEMENT AND IS NOT PROVED**, in the kernel's own idiom found by description in four sibling modules: prose in the docstring plus a correspondence row, **NEVER A SORRY AND NEVER A Prop-VALUED DEFINITION**. **THE REFUTATION IS NOW THE KERNEL'S RATHER THAN A TRANSCRIPTION'S**: the seven cells re-decided inside the kernel as a positive control, 6 decided to break the identity at 468 against 324 while satisfying the seal's own 2 <= p, and 4, 8, 9 decided to keep it while composite. **THE PREDICATE IS CERTIFIED AT ALL EIGHTEEN OF b413'S BASES; THE IDENTITY ONLY AT WHAT REDUCTION AFFORDS -- TWO REACHES, KEPT APART.** **THE FRONTIER IS SHARP AND WAS MEASURED**: base 10 in seconds, base 12 at 292s not landing, 2.1x the work for more than 28x the time. **AN AFFORDABILITY LIMIT IS NOT A RESULT ABOUT THE ARITHMETIC.** **AND AN OVER-BUDGET decide YIELDS sorryAx INSTEAD OF FAILING** -- so the bar moved from the exit code to the printed profile. **THE SEAL'S (T1.4) AND THE NAVIGATOR'S 'primality unused' ARE THE SAME SENTENCE AND NEITHER IS FALSE**: the error is carrying one across a clause of a different kind, which is (R28). **THE CAVEAT IS TOO STRONG BY 8 COMPOSITE BASES AND EXCLUDES 0 OF THE SEVEN DECIDED CELLS**, which is why it survived 85 acts -- **A CAVEAT SOUND ON ITS OWN EVIDENCE IS NOT A CAVEAT TESTED**. **THE TWENTY-EIGHT ARE SORTED, 8 REACHED BY A PROOF AND 20 NOT, 0 EDITED**, and the fact that decides them is that **THE CORPUS INDEXES ITS FINITE PLACES BY PRIMES**, so the failure at 6 was never the threat -- **THE THREAT WAS ALWAYS THAT THE STATEMENT WAS PROVED AT SEVEN CELLS**. **ACT 1 COST ONE ACT: THE FLOOR OF TWO IS HALF-DISCHARGED, NOT MOVED, AND THE UPPER END IS STILL NOT THIS SEAT'S TO GIVE** -- **NO FINITE LIST IS THE STATEMENT**.",
     '### NO EXISTING `.lean` FILE EDITED, NO MATHLIB IMPORT ADDED, NO AXIOM ADDED, NO SORRY IN CODE OR PROFILE, NO BUILD ARTEFACT COMMITTED. ### NO GRADE MOVED CONFERRED OR MINTED, NO PREMISE DISCHARGED, NO DOOR RESTATED, NO KAPPA MEASURED, NO CHANNEL OPENED, NO ROUTE PROPOSED, NO LEDGER ROW WRITTEN, NO FOLD RUN, NO ORIENTATION-LAYER LINE EDITED, NO SENTENCE REPAIRED, NO RULE STRUCK OR AMENDED, NO LOCKED FACE OR PRIOR BANK EDITED. ### THE INSTRUMENT AND INSTRUMENT-AUDIT LANES STAY PARKED. ### NOTHING DEPOSITS AND THE PLATFORM WAS NOT CALLED AT ALL. ### THE CLAUSE IS STATED AND HAS NOT BEEN PROVED',
     'data/b414_the_predicate_named.txt; data/b414_components.txt; data/b414_sorted.txt; data/b414_ladder.txt; data/b414_registration_2026-09-10.txt (LOCKED before any write, chained on tools/b378_lockgate.py run as b414 -- 8 gates read, 4 checked by digest); tools/b414_extract.py; tools/b414_components.py; tools/b414_desk_bank.py; tools/b414_checks.py; SIDE-global-section Core/SinglePrimeFactor.lean; PLACE-papers OPEN_TRAILS.md; CORRESPONDENCE.md row 263'),
