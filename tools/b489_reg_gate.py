# -*- coding: utf-8 -*-
"""b489_reg_gate.py -- THE REGISTRATION GATE, RUN BEFORE THE LOCK. ### ALL THREE ARMS.
...
REG = os.path.join(D, 'b489_registration_2026-09-23.txt')
OUT = os.path.join(D, 'b489_reg_gate.txt')
...
def main():
    rec('=' * 100)
    rec('b489 -- THE REGISTRATION GATE, RUN BEFORE THE LOCK.')
    rec('=' * 100)
