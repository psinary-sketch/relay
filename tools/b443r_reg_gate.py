# -*- coding: utf-8 -*-
"""b443r_reg_gate.py -- THE REGISTRATION GATE, RUN BEFORE THE LOCK. ### ALL THREE ARMS.
...
REG = os.path.join(D, 'b443r_registration_2026-09-12.txt')
OUT = os.path.join(D, 'b443r_reg_gate.txt')
...
def main():
    rec('=' * 100)
    rec('b443 -- THE REGISTRATION GATE, RUN BEFORE THE LOCK.')
    rec('=' * 100)
