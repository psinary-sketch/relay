# -*- coding: utf-8 -*-
"""b449_reg_gate.py -- THE REGISTRATION GATE, RUN BEFORE THE LOCK. ### ALL THREE ARMS.
...
REG = os.path.join(D, 'b449_registration_2026-09-13.txt')
OUT = os.path.join(D, 'b449_reg_gate.txt')
...
def main():
    rec('=' * 100)
    rec('b449 -- THE REGISTRATION GATE, RUN BEFORE THE LOCK.')
    rec('=' * 100)
