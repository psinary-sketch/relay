# -*- coding: utf-8 -*-
"""b469_regspec.py -- THE REGISTRATION'S SATISFIABILITY SPEC. ### **COMPUTED, NOT TYPED.**
...
REG = os.path.join(ROOT, 'data', 'b469_registration_2026-09-22.txt')
SPEC = os.path.join(ROOT, 'data', 'b469_satisfiable.json')
...
CLAUSES = [
    ...
    ('addendum slots declared in the write list', 1, 1, 'slots', '### (W) and (R50): data/b469_addendum.txt.'),
...
def main(argv):
    print('=' * 100)
    print('b469_regspec.py -- THE SATISFIABILITY SPEC. ### THE COUNTER IS IMPORTED, NOT COPIED.')
    print('=' * 100)
    ...
    spec = {"registration": ("data/b469_registration_2026-09-22.txt -- b458, "
