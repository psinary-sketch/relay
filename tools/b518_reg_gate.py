# -*- coding: utf-8 -*-
"""b518_reg_gate.py -- THE REGISTRATION GATE, RUN BEFORE THE LOCK. ### ALL THREE ARMS.
...
REG = os.path.join(D, 'b518_registration_2026-09-24.txt')
OUT = os.path.join(D, 'b518_reg_gate.txt')
...
def main():
    rec('=' * 100)
    rec('b518 -- THE REGISTRATION GATE, RUN BEFORE THE LOCK.')
    rec('=' * 100)
