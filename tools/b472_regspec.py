# -*- coding: utf-8 -*-
"""b472_regspec.py -- THE REGISTRATION'S SATISFIABILITY SPEC. ### **COMPUTED, NOT TYPED.**
...
REG = os.path.join(ROOT, 'data', 'b472_registration_2026-09-22.txt')
SPEC = os.path.join(ROOT, 'data', 'b472_satisfiable.json')
...
CLAUSES = [
    ...
    ('readings of the order declared in advance on this face', 8, 8, 'readings', '### section (A): (1) to (8).'),
    ...
    ('addendum slots declared in the write list', 1, 1, 'slots', '### (W) and (R50): data/b472_addendum.txt.'),
    ...
    ('existing `relay` tools edited in place', 1, 1, 'tools', '### (W) and reading (2): ferry_scan.py, under (R81) as amended.'),
...
def main(argv):
    print('=' * 100)
    print('b472_regspec.py -- THE SATISFIABILITY SPEC. ### THE COUNTER IS IMPORTED, NOT COPIED.')
    print('=' * 100)
    ...
    spec = {"registration": ("data/b472_registration_2026-09-22.txt -- b458, "
