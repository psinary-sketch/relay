# -*- coding: utf-8 -*-
"""b450_reg_gate.py -- THE REGISTRATION GATE, RUN BEFORE THE LOCK. ### ALL THREE ARMS.
...
REG = os.path.join(D, 'b450_registration_2026-09-13.txt')
OUT = os.path.join(D, 'b450_reg_gate.txt')
...
def main():
    rec('=' * 100)
    rec('b450 -- THE REGISTRATION GATE, RUN BEFORE THE LOCK.')
    rec('=' * 100)
