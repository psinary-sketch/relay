# -*- coding: utf-8 -*-
"""b481_regspec.py -- THE REGISTRATION'S SATISFIABILITY SPEC. ### **COMPUTED, NOT TYPED.**
...
REG = os.path.join(ROOT, 'data', 'b481_registration_2026-09-22.txt')
SPEC = os.path.join(ROOT, 'data', 'b481_satisfiable.json')
...
CLAUSES = [
    ...
    ('chains run, or channel values computed', 0, 0, 'runs', '### section (Z): this act reads files on disk.'),
    ...
    ('readings of the order declared in advance on this face', 5, 5, 'readings', '### section (A): (1) to (5).'),
    ...
    ('addendum slots declared in the write list', 1, 1, 'slots', '### (W) and (R50): data/b481_addendum.txt.'),
...
def main(argv):
    print('=' * 100)
    print('b481_regspec.py -- THE SATISFIABILITY SPEC. ### THE COUNTER IS IMPORTED, NOT COPIED.')
    print('=' * 100)
    ...
    spec = {"registration": ("data/b481_registration_2026-09-22.txt -- b458, "
