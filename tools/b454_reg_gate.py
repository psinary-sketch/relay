# -*- coding: utf-8 -*-
"""b454_reg_gate.py -- THE REGISTRATION GATE, RUN BEFORE THE LOCK. ### ALL THREE ARMS.
...
REG = os.path.join(D, 'b454_registration_2026-09-14.txt')
OUT = os.path.join(D, 'b454_reg_gate.txt')
...
def main():
    rec('=' * 100)
    rec('b454 -- THE REGISTRATION GATE, RUN BEFORE THE LOCK.')
    rec('=' * 100)
