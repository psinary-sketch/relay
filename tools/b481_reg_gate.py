# -*- coding: utf-8 -*-
"""b481_reg_gate.py -- THE REGISTRATION GATE, RUN BEFORE THE LOCK. ### ALL THREE ARMS.
...
REG = os.path.join(D, 'b481_registration_2026-09-22.txt')
OUT = os.path.join(D, 'b481_reg_gate.txt')
...
def main():
    rec('=' * 100)
    rec('b481 -- THE REGISTRATION GATE, RUN BEFORE THE LOCK.')
    rec('=' * 100)
