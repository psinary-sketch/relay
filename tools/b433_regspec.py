# -*- coding: utf-8 -*-
"""b433_regspec.py -- THE REGISTRATION'S SATISFIABILITY SPEC. ### **COMPUTED, NOT TYPED.**
...
REG = os.path.join(ROOT, 'data', 'b433_registration_2026-09-12.txt')
SPEC = os.path.join(ROOT, 'data', 'b433_satisfiable.json')
...
CLAUSES = [
    ...
    ('author rulings ratified by this paste', 5, 5, 'rulings', '### section (A): (R41) to (R45), quoted in reading (1).'),
    ...
    ('keystones annotated by a ruling`s own order', 1, 1, 'keystones', '### (W): the conspiracy keystone, by (R42).'),
...
def main(argv):
    print('=' * 100)
    print('b433_regspec.py -- THE SATISFIABILITY SPEC. ### THE COUNTER IS IMPORTED, NOT COPIED.')
    print('=' * 100)
    ...
    spec = {"registration": ("data/b433_registration_2026-09-12.txt -- b433, THE EXTERNAL GRADING READ"),
            "clauses": clauses}
