# -*- coding: utf-8 -*-
"""b420_reg_gate.py -- THE REGISTRATION GATE, RUN BEFORE THE LOCK. ### ALL THREE ARMS.
...
REG = os.path.join(D, 'b420_registration_2026-09-11.txt')
OUT = os.path.join(D, 'b420_reg_gate.txt')
...
def main():
    rec('=' * 100)
    rec('b420 -- THE REGISTRATION GATE, RUN BEFORE THE LOCK.')
    rec('=' * 100)
