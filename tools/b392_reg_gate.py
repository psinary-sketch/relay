# -*- coding: utf-8 -*-
"""b392_reg_gate.py -- THE REGISTRATION GATE, RUN BEFORE THE LOCK. ### ALL THREE ARMS.
...
REG = os.path.join(D, 'b392_registration_2026-09-09.txt')
OUT = os.path.join(D, 'b392_reg_gate.txt')
...
def main():
    rec('=' * 100)
    rec('b392 -- THE REGISTRATION GATE, RUN BEFORE THE LOCK.')
    rec('=' * 100)
