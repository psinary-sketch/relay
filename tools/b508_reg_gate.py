# -*- coding: utf-8 -*-
"""b508_reg_gate.py -- THE REGISTRATION GATE, RUN BEFORE THE LOCK. ### ALL THREE ARMS.
...
REG = os.path.join(D, 'b508_registration_2026-09-24.txt')
OUT = os.path.join(D, 'b508_reg_gate.txt')
...
def main():
    rec('=' * 100)
    rec('b508 -- THE REGISTRATION GATE, RUN BEFORE THE LOCK.')
    rec('=' * 100)
