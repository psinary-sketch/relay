# -*- coding: utf-8 -*-
"""b435_reg_gate.py -- THE REGISTRATION GATE, RUN BEFORE THE LOCK. ### ALL THREE ARMS.
...
REG = os.path.join(D, 'b435_registration_2026-09-12.txt')
OUT = os.path.join(D, 'b435_reg_gate.txt')
...
def main():
    rec('=' * 100)
    rec('b435 -- THE REGISTRATION GATE, RUN BEFORE THE LOCK.')
    rec('=' * 100)
