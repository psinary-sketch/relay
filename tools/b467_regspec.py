# -*- coding: utf-8 -*-
"""b467_regspec.py -- THE REGISTRATION'S SATISFIABILITY SPEC. ### **COMPUTED, NOT TYPED.**
...
REG = os.path.join(ROOT, 'data', 'b467_registration_2026-09-22.txt')
SPEC = os.path.join(ROOT, 'data', 'b467_satisfiable.json')
...
CLAUSES = [
    ...
    ('addendum slots declared in the write list', 1, 1, 'slots', '### (W) and (R50): data/b467_addendum.txt.'),
...
def main(argv):
    print('=' * 100)
    print('b467_regspec.py -- THE SATISFIABILITY SPEC. ### THE COUNTER IS IMPORTED, NOT COPIED.')
    print('=' * 100)
    ...
    spec = {"registration": ("data/b467_registration_2026-09-22.txt -- b458, "
