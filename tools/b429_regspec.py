# -*- coding: utf-8 -*-
"""b429_regspec.py -- THE REGISTRATION'S SATISFIABILITY SPEC. ### **COMPUTED, NOT TYPED.**
...
REG = os.path.join(ROOT, 'data', 'b429_registration_2026-09-12.txt')
SPEC = os.path.join(ROOT, 'data', 'b429_satisfiable.json')
...
def main(argv):
    print('=' * 100)
    print('b429_regspec.py -- THE SATISFIABILITY SPEC. ### THE COUNTER IS IMPORTED, NOT COPIED.')
    print('=' * 100)
    ...
    spec = {"registration": ("data/b429_registration_2026-09-12.txt -- b429, THE EXTERNAL GRADING READ"),
            "clauses": clauses}
