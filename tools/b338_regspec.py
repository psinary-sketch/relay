# -*- coding: utf-8 -*-
"""b338_regspec.py -- THE REGISTRATION'S SATISFIABILITY SPEC, ### **COMPUTED, NOT TYPED.**
...
REG = os.path.join(ROOT, 'data', 'b338_registration_2026-09-06.txt')
SPEC = os.path.join(ROOT, 'data', 'b338_satisfiable.json')

if hasattr(sys.stdout, 'reconfigure'):
    sys.stdout.reconfigure(encoding='utf-8', errors='replace')

CLAUSES = [
    ("PLACE-papers files written", 1, 1, "files", "### section (F): FINDINGS.md, one appended section."),
    ("findings sections appended", 1, 1, "sections", "### section (F)."),
    ("findings sections edited", 0, 0, "sections", "none; RE-MEASURED by G-ADDITIVE."),
    ("correspondence rows appended", 2, 2, "rows", "### section (F): the filing; the arc as one statement."),
    ...
    ("keystones created or edited", 0, 0, "files", "section (A)."),
    ("TECHNE files written", 0, 0, "files", "section (A): TECHNE is not touched."),
...
def main(argv):
    print('=' * 100)
    print('b338_regspec.py -- THE SATISFIABILITY SPEC. ### THE COUNTER IS IMPORTED, NOT COPIED.')
    print('=' * 100)
    ...
    spec = {"registration": "data/b338_registration_2026-09-06.txt -- b338, THE FOLD b331-b334", "clauses": clauses}
