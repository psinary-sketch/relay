# -*- coding: utf-8 -*-
"""b445_reg_gate.py -- THE REGISTRATION GATE, RUN BEFORE THE LOCK. ### ALL THREE ARMS.
...
REG = os.path.join(D, 'b445_registration_2026-09-12.txt')
OUT = os.path.join(D, 'b445_reg_gate.txt')
