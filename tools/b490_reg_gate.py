# -*- coding: utf-8 -*-
"""b490_reg_gate.py -- THE REGISTRATION GATE, RUN BEFORE THE LOCK. ### ALL THREE ARMS.
...
REG = os.path.join(D, 'b490_registration_2026-09-23.txt')
OUT = os.path.join(D, 'b490_reg_gate.txt')
...
def main():
    rec('=' * 100)
    rec('b490 -- THE REGISTRATION GATE, RUN BEFORE THE LOCK.')
    rec('=' * 100)
