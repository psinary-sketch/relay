# -*- coding: utf-8 -*-
"""b459_reg_gate.py -- THE REGISTRATION GATE, RUN BEFORE THE LOCK. ### ALL THREE ARMS.
...
REG = os.path.join(D, 'b459_registration_2026-09-21.txt')
OUT = os.path.join(D, 'b459_reg_gate.txt')
...
def main():
    rec('=' * 100)
    rec('b459 -- THE REGISTRATION GATE, RUN BEFORE THE LOCK.')
    rec('=' * 100)
