# -*- coding: utf-8 -*-
"""b425_regspec.py -- THE REGISTRATION'S SATISFIABILITY SPEC. ### **COMPUTED, NOT TYPED.**
...
REG = os.path.join(ROOT, 'data', 'b425_registration_2026-09-11.txt')
SPEC = os.path.join(ROOT, 'data', 'b425_satisfiable.json')
...
CLAUSES = [
    ...
    ('query strings fixed on this face', 3, 3, 'queries', '### (A) reading (3): Q1 to Q3.'),
    ('sources fetched beyond the cap', 0, 0, 'sources', '### (K) BAR 5: three.'),
    ...
    ('parts of the tension stated', 3, 3, 'parts', '### (A) reading (5).'),
    ('lane verdicts changed by the seat', 0, 0, 'verdicts', '### (K) BAR 2.'),
    ('lane documents or register rows edited', 0, 0, 'rows', '### (K) BAR 2.'),
...
def main(argv):
    print('=' * 100)
    print('b425_regspec.py -- THE SATISFIABILITY SPEC. ### THE COUNTER IS IMPORTED, NOT COPIED.')
    print('=' * 100)
    ...
    spec = {"registration": ("data/b425_registration_2026-09-11.txt -- b425, SORTIE LEG 3, THE FALSIFIER READ"),
            "clauses": clauses}
