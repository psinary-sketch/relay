# -*- coding: utf-8 -*-
"""b426_reg_gate.py -- THE REGISTRATION GATE, RUN BEFORE THE LOCK. ### ALL THREE ARMS.
...
REG = os.path.join(D, 'b426_registration_2026-09-11.txt')
OUT = os.path.join(D, 'b426_reg_gate.txt')
...
def main():
    rec('=' * 100)
    rec('b426 -- THE REGISTRATION GATE, RUN BEFORE THE LOCK.')
    rec('=' * 100)
