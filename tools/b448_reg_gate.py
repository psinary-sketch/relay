# -*- coding: utf-8 -*-
"""b448_reg_gate.py -- THE REGISTRATION GATE, RUN BEFORE THE LOCK. ### ALL THREE ARMS.
...
REG = os.path.join(D, 'b448_registration_2026-09-13.txt')
OUT = os.path.join(D, 'b448_reg_gate.txt')
...
def main():
    rec('=' * 100)
    rec('b448 -- THE REGISTRATION GATE, RUN BEFORE THE LOCK.')
    rec('=' * 100)
