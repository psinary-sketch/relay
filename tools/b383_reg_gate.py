# -*- coding: utf-8 -*-
"""b383_reg_gate.py -- THE REGISTRATION GATE, RUN BEFORE THE LOCK. ### ALL THREE ARMS.
...
REG = os.path.join(D, 'b383_registration_2026-09-09.txt')
OUT = os.path.join(D, 'b383_reg_gate.txt')
...
def main():
    rec('=' * 100)
    rec('b383 -- THE REGISTRATION GATE, RUN BEFORE THE LOCK.')
    rec('=' * 100)
