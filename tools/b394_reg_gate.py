# -*- coding: utf-8 -*-
"""b394_reg_gate.py -- THE REGISTRATION GATE, RUN BEFORE THE LOCK. ### ALL THREE ARMS.
...
REG = os.path.join(D, 'b394_registration_2026-09-09.txt')
OUT = os.path.join(D, 'b394_reg_gate.txt')
...
def main():
    rec('=' * 100)
    rec('b394 -- THE REGISTRATION GATE, RUN BEFORE THE LOCK.')
    rec('=' * 100)
