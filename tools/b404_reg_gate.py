# -*- coding: utf-8 -*-
"""b404_reg_gate.py -- THE REGISTRATION GATE, RUN BEFORE THE LOCK. ### ALL THREE ARMS.
...
REG = os.path.join(D, 'b404_registration_2026-09-10.txt')
OUT = os.path.join(D, 'b404_reg_gate.txt')
...
def main():
    rec('=' * 100)
    rec('b404 -- THE REGISTRATION GATE, RUN BEFORE THE LOCK.')
    rec('=' * 100)
