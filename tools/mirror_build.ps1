...
$man += "ROSTER CHANGE: INDEX_ARITY_AT_THE_CRITICAL_LINE.md ADDED to the mirror set this build"
$man += "(it was marked [off-mirror-set] through 2026-08-02); added on the ferry's verification"
$man += "requirement. All other roster entries unchanged."
$man += ""
