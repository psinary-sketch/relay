# -*- coding: utf-8 -*-
"""b453_reg_gate.py -- THE REGISTRATION GATE, RUN BEFORE THE LOCK. ### ALL THREE ARMS.
...
REG = os.path.join(D, 'b453_registration_2026-09-14.txt')
OUT = os.path.join(D, 'b453_reg_gate.txt')
...
def main():
    rec('=' * 100)
    rec('b453 -- THE REGISTRATION GATE, RUN BEFORE THE LOCK.')
    rec('=' * 100)
