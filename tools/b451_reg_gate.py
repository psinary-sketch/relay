# -*- coding: utf-8 -*-
"""b451_reg_gate.py -- THE REGISTRATION GATE, RUN BEFORE THE LOCK. ### ALL THREE ARMS.
...
REG = os.path.join(D, 'b451_registration_2026-09-13.txt')
OUT = os.path.join(D, 'b451_reg_gate.txt')
...
def main():
    rec('=' * 100)
    rec('b451 -- THE REGISTRATION GATE, RUN BEFORE THE LOCK.')
    rec('=' * 100)
