# -*- coding: utf-8 -*-
"""b343_regspec.py -- THE REGISTRATION'S SATISFIABILITY SPEC, ### **COMPUTED, NOT TYPED.**
...
REG = os.path.join(ROOT, 'data', 'b343_registration_2026-09-06.txt')
SPEC = os.path.join(ROOT, 'data', 'b343_satisfiable.json')
...
CLAUSES = [
    ...
    ("heights or widths added after a value", 0, 0, "points", "### section (C): the grid fixed before any value."),
    ...
    ("conclusions about the floor's other candidates", 0, 0, "conclusions", "### section (D): the reading rule, and no wider."),
...
def main(argv):
    print('=' * 100)
    print('b343_regspec.py -- THE SATISFIABILITY SPEC. ### THE COUNTER IS IMPORTED, NOT COPIED.')
    print('=' * 100)
    ...
    spec = {"registration": "data/b343_registration_2026-09-06.txt -- b343, THE MAP'S NEXT REACH", "clauses": clauses}
