# -*- coding: utf-8 -*-
"""b462_reg_gate.py -- THE REGISTRATION GATE, RUN BEFORE THE LOCK. ### ALL THREE ARMS.
...
REG = os.path.join(D, 'b462_registration_2026-09-21.txt')
OUT = os.path.join(D, 'b462_reg_gate.txt')
...
def main():
    rec('=' * 100)
    rec('b462 -- THE REGISTRATION GATE, RUN BEFORE THE LOCK.')
    rec('=' * 100)
