# -*- coding: utf-8 -*-
"""b478_regspec.py -- THE REGISTRATION'S SATISFIABILITY SPEC. ### **COMPUTED, NOT TYPED.**
...
REG = os.path.join(ROOT, 'data', 'b478_registration_2026-09-22.txt')
SPEC = os.path.join(ROOT, 'data', 'b478_satisfiable.json')
...
CLAUSES = [
    ...
    ('chains run, or channel values computed', 0, 0, 'runs', '### section (Z) and (K) BAR 6: no lane opens, b321_window is NOT executed.'),
    ...
    ('addendum slots declared in the write list', 1, 1, 'slots', '### (W) and (R50): data/b478_addendum.txt.'),
...
def main(argv):
    print('=' * 100)
    print('b478_regspec.py -- THE SATISFIABILITY SPEC. ### THE COUNTER IS IMPORTED, NOT COPIED.')
    print('=' * 100)
    ...
    spec = {"registration": ("data/b478_registration_2026-09-22.txt -- b458, "
