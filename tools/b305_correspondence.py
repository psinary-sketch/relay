# -*- coding: utf-8 -*-
"""b305_correspondence.py -- TWO ROWS: WHERE THE ARITHMETIC ENTERS, AND THE SPECIES MATCH.
...
def main():
    ...
    print('=' * 100)
    print('b305 -- THE ENTRY\'S ROW, AND THE SPECIES MATCH\'S ROW.')
    print('=' * 100)
    ...
    g1 = ('NO TERMINAL' in r1[2] and 'NO PRINT' in r1[3]
          and 'IS NOT A RESULT OF THE CORPUS' in r1[4])
    g2 = ('HAVING THE OBJECT IS NOT DOING WITH IT WHAT THE SOURCE' in r2[4]
          and 'NO TERMINAL' in r2[2])
    print('  row 1 declares no terminal/print and refuses to be a corpus result : %s  %s'
          % (g1, 'PASS' if g1 else '### FAIL ###'))
    print('  row 2 refuses the identification as a capability : %s  %s'
