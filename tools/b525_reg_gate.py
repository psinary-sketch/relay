# -*- coding: utf-8 -*-
"""b525_reg_gate.py -- THE REGISTRATION GATE, RUN BEFORE THE LOCK. ### ALL THREE ARMS.
...
REG = os.path.join(D, 'b525_registration_2026-09-25.txt')
OUT = os.path.join(D, 'b525_reg_gate.txt')
...
def main():
    rec('=' * 100)
    rec('b525 -- THE REGISTRATION GATE, RUN BEFORE THE LOCK.')
    rec('=' * 100)
