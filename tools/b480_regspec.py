# -*- coding: utf-8 -*-
"""b480_regspec.py -- THE REGISTRATION'S SATISFIABILITY SPEC. ### **COMPUTED, NOT TYPED.**
...
REG = os.path.join(ROOT, 'data', 'b480_registration_2026-09-22.txt')
SPEC = os.path.join(ROOT, 'data', 'b480_satisfiable.json')
...
CLAUSES = [
    ...
    ('chains run, or channel values computed', 0, 0, 'runs', '### section (Z): none; this act reads a log.'),
    ...
    ('addendum slots declared in the write list', 1, 1, 'slots', '### (W) and (R50): data/b480_addendum.txt.'),
    ('addendum slots carrying anything but a verbatim quotation', 0, 0, 'slots', '### (R50).'),
    ('expectations registered', 0, 0, 'expectations', '### section (J): none new; b475`s (N1) is SCORED here.'),
...
def main(argv):
    print('=' * 100)
    print('b480_regspec.py -- THE SATISFIABILITY SPEC. ### THE COUNTER IS IMPORTED, NOT COPIED.')
    print('=' * 100)
    ...
    spec = {"registration": ("data/b480_registration_2026-09-22.txt -- b458, "
