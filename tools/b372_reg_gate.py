# -*- coding: utf-8 -*-
"""b372_reg_gate.py -- THE REGISTRATION GATE, RUN BEFORE THE LOCK. ### ALL THREE ARMS.
...
OUT = os.path.join(D, 'b372_reg_gate.txt')
...
def main():
    rec('=' * 100)
    rec('b372 -- THE REGISTRATION GATE, RUN BEFORE THE LOCK.')
    rec('=' * 100)
