# -*- coding: utf-8 -*-
"""b511_reg_gate.py -- THE REGISTRATION GATE, RUN BEFORE THE LOCK. ### ALL THREE ARMS.
...
REG = os.path.join(D, 'b511_registration_2026-09-24.txt')
OUT = os.path.join(D, 'b511_reg_gate.txt')
...
def main():
    rec('=' * 100)
    rec('b511 -- THE REGISTRATION GATE, RUN BEFORE THE LOCK.')
    rec('=' * 100)
